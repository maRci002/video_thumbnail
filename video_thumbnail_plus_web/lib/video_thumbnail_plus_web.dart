...
/// A web implementation of the VideoThumbnailPlusPlatform of the VideoThumbnailPlus plugin.
class VideoThumbnailPlusWeb extends VideoThumbnailPlusPlatform {
  /// Constructs a VideoThumbnailPlusWeb
  VideoThumbnailPlusWeb();

  static void registerWith(Registrar registrar) {
    VideoThumbnailPlusPlatform.instance = VideoThumbnailPlusWeb();
  }
